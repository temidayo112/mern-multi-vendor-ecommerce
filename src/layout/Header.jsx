            ...
            <div className='ml-0 lg:ml-[260px] rounded-md h-[65px] flex justify-between
             items-center bg-[#b1addf] px-5 transition-all'>
                ...
                <div className='hidden md:block'>
                    <input className='px-3 py-2 outline-none border bg-transparent border-slate-700
                     rounded-md text-[#423d72] focus:border-indigo-300 overflow-hidden' type="text" name='search' placeholder='search' />
                </div>
                 ...
                 <div className='flex justify-center items-center gap-8 relative'>
                    ...
                    <span className='text-[14px] w-full font-normal'>{ userInfo.role }</span>
...

                        {
                            ...
                            overflow-hidden' src="http://localhost:3001/images/admin.jpg" alt="" />  : 
