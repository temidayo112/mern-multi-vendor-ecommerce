...
const Products = () => {
    ...
    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
        ...
        <Link to={`/seller/dashboard/edit-product/${d._id}`} className='p-[6px] bg-yellow-500 rounded hover:shadow-lg
         hover:shadow-yellow-500/50'> <FaEdit/> </Link> 

        <Link to={`/seller/dashboard/add-banner/${d._id}`} className='p-[6px] bg-sky-500 rounded hover:shadow-lg
         hover:shadow-yellow-500/50'> <LuImageMinus /> </Link>
